...
import {saveCityNameOnStorage, updateFavoritelist, saveCityNameOnCookie} from "./storage.js";
...
function addFavoriteCity() {
  ...
  try {
    for (const elem of favoriteCityList.children) {
  ...
  const favoriteCityStorage = favoriteCityList.innerHTML;
  updateFavoritelist(favoriteCityStorage);
}

function dataOutputOnScreen(result) {
  const node = document.querySelectorAll(".main__city");
